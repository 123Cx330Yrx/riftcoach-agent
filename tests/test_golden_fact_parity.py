...
from app.runtime.coach_contract import FACT_COACH_CONTRACT, POSITION_COACH_CONTRACT, ADVICE_COACH_CONTRACT, COMPACT_COACH_CONTRACT
...
@pytest.mark.parametrize("contract,expected", [(FACT_COACH_CONTRACT, True), (POSITION_COACH_CONTRACT, False), (ADVICE_COACH_CONTRACT, True), (COMPACT_COACH_CONTRACT, True)])
