...
def implementation_identity(*, bounded=False, full_context=False, comparison=False, provisional=False, meaning=False):
    ...
    if bounded or full_context or comparison or provisional or meaning:
    ...
    if full_context or comparison or provisional or meaning:
    ...
    if comparison or provisional or meaning:
...
def run(args, *, bounded=False, full_context=False, comparison=False, provisional=False, meaning=False):
    ...
    plan = dict(experiment_id=experiment_id, implementation=implementation_identity(bounded=bounded, full_context=full_context, comparison=comparison, provisional=provisional, meaning=meaning),
...
def main(*, bounded=False, full_context=False, comparison=False, provisional=False, meaning=False):
    ...
    run(p.parse_args(), bounded=bounded, full_context=full_context, comparison=comparison, provisional=provisional, meaning=meaning)
