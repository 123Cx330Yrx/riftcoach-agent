...
def run(args):
    ...
    evidence_scope_v7 = getattr(args, "evidence_scope_v7", False)
    if evidence_scope_v7 and getattr(args, "evidence_scope_v6", False):
        raise ValueError("exclusive_evidence_version_required")
    evidence_scope_v6 = getattr(args, "evidence_scope_v6", False) or evidence_scope_v7
...
def main():
    ...
    p.add_argument("--evidence-scope-v7", action="store_true")
