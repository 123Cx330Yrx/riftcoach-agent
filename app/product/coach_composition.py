...
def build_coach_application(
    *,
    ...
    if coach_contract is CLAIM_COACH_CONTRACT:
    ...
    if coach_contract is SCOPE_V3_COACH_CONTRACT:
        assets = _COACH_ASSETS.parent / "flash_v2_golden_scope_v3"
    if coach_contract is SCOPE_V2_COACH_CONTRACT:
        assets = _COACH_ASSETS.parent / "flash_v2_golden_scope_v2"
