...
class CoachContractSnapshot(BaseModel):
    ...
    version: Literal["1.0.0", "1.1.0", "1.2.0", "1.3.0", "1.3.1", "1.3.2", "1.3.3", "1.3.4", "1.3.5", "1.3.6", "1.3.7", "1.3.8", "1.3.9", "1.3.10", "1.3.11", "1.3.12", "1.3.13", "1.3.14", "1.3.15", "1.3.16", "1.3.17", "1.3.18", "1.3.19", "1.3.20", "1.3.21", "1.3.22", "1.3.23", "1.3.24", "1.3.25", "1.3.26", "1.3.27", "1.4.0", "1.4.1", "1.4.2", "1.4.3"] = "1.0.0"
...
class NativeCoachExecutionContract(CoachExecutionContract):
    ...
    def descriptor(self):
        ...
        value.update(version=self.version, skill_version="0.6.0", program_version="3.0.3",
            evaluation_contract_version="3.1.0", inference_policy_id="golden-native-issues-review-v3.3",
            evaluation_repair_policy="one-full-native-reassessment-with-original-response",
            context_policy_sha256=hashlib.sha256(self.context_policy.encode()).hexdigest())
        return value


NATIVE_COACH_CONTRACT = NativeCoachExecutionContract(version="1.4.3")
