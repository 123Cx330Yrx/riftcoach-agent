...
from app.evaluation.golden_evidence_requests_v2 import evaluation_request, revision_request, POLICY
...
def inference_component_fingerprints(skill):
    ...
    for name in ("golden_fact_candidate", "golden_numeric_evidence_v2", "golden_evidence_scope_v2", "golden_evidence_requests_v2", "golden_scope_diagnostics", "golden_evidence_runtime_v2"):
