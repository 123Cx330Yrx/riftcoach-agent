...
2026-09-15窄目标诊断v1完成但未通过：6a73101dbf6d342686fe6aa219f19ad7d247cf95/Actions34940550415三项success；context-relation-6a73101-critical四次均完整stop（约6–13秒），37452输入+1748输出=39200tokens，无未知用量，累计Provider至少166。3份协议有效、1无效，只有2份目标匹配：普通稳定含混已澄清，前置定义通过；标题把定义缺失过判成确定外推（还附带不准确的2–3场解释）；后置定义理解合理但重复逐字抄写字段失败，旧结果不改。新独立probe-v2去掉冗余定义摘录，保留完整原文context_ref和自由解释，明确未定义含义与明确越界的区别；36项相关测试通过，旧失败投影只验证新结构、非实测。唯一下一步为该修正自身同SHA公共三项检查后，以新实验身份至多4次完整四例诊断（无纠正/修订），若仍失败不自动追加第三轮；不把不同版本拼成全过。保持high/32768/300秒/401920tokens及900秒单批上界，诊断不替代整篇评估，8E仍in_progress，Workbench与四块后续设计保持。详见docs/adr/0102-evaluation-reference-protocol-experiment.md。
