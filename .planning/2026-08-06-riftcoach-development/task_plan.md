...
| DeepSeek 协议证据归档收尾的 GitHub CI 查询路径遇到 TLS 超时 | 5 | 三轮 push 均成功且工作树无功能漂移；停止原样重试不稳定的 `gh` 查询，前两轮已分别确认 runs `31779362817`、`31779529184` completed/success，最终记录提交固定使用有界 PowerShell REST 核验 |
