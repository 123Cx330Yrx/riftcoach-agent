...
当前唯一行动：独立provisional-review实现通过同SHA公共CI后，按既有授权执行冻结正例并逐项人工核对目标、样本、解释、标题与问题处置；合格再执行负例真实修订复评。任何失败停止本批，整体裁决后续；两条旧入口保持offline_only。离线整体合同已裁决、159项不同相关检查通过，预算与high不变。
