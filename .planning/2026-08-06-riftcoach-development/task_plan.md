...
2026-09-19 computed-partition整体分工完成离线资格验证：程序提供全部cohort/metric的比较与均值中位数，按模型所选cohort/key展开成员和来源类型；两批各见全文，前1/3正文先审，第二批可整块纠错并独立给全局裁决。单一协议消除旧阶段/字段冲突；首批原值、旧issues、全文覆盖、native TypedReview和最终校验保留。正反例输入53666/61412、53734/61314；坏引用+重复+误报组合63632<63936；完整五步脚本路径可达，均为合成证明，语义和时延未证明。同方向错样本仍可结构通过，必须人工检查真实解释。七个旧失败入口继续offline_only；原36b41b5失败证据已留存，Provider累计至少205。下一步：本实现同SHA公共三项后，仅跑真实冻结正例并逐条核查，合格才负例修订复评；失败停批不局部付费重跑。详见docs/plans/2026-09-19-review-workload-partition.md及对应offline artifact。8E/high/全部上限与完整上下文标准、前端审美/头像/四块联动及62主题后续均不变。
