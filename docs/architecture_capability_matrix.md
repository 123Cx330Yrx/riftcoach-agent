...
| A15 | 标准 MCP 与动态 Meta | 内部 Tool Runtime，不冒充 MCP；ADR-0047/0048 冻结 Adapter-first 与 partial provenance；7-1/7-2 已由 `37f16bc/32439753589`、`f121666/32441793585` 公共闭环；7-3 已本地实现官方 Streamable HTTP、admitted-subset discovery、严格 lane-meta Adapter、MetaEvidence/Context 与真实 body-free smoke | 阶段 7 | Riot 官方版本/静态/patch 事实与 OP.GG 聚合 Meta 分层；其他 OP.GG 工具逐项 Adapter | initialize、tools/list、tools/call、断线和版本边界测试；真实外部 Server/Client 互操作 | 进行中（7-3 本地实现，待完整门与 exact-SHA 公共 CI；7-4/7-5 未进入） |
...
| Q05 | 数据生命周期与隐私 | 本地缓存不提交；6A-6 已公开验证 task/run 生命周期；6B-9 owner export、三 scope hidden-before-cleanup、marker retry、retention/purge 已由 `cbc7cbd/32408101770` 完成真库/Linux 公共闭环 | 阶段 6 已完成 Memory 的查看/导出/更正/删除/补偿 V1 | 阶段 8 加备份副本擦除、恢复和公开隐私说明 | 原始比赛、Run、Memory 的保留、更正、导出、删除失败补偿测试 | V1 已完成，阶段 8 深化 |
