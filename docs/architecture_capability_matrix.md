...
| Q10 | 前端可解释性与可访问性 | 尚无正式产品前端；阶段 6 只提供 owner-scoped API/Session 合同；8E 入口设计已冻结五个模块和 MotionSites 资源门 | Stage 8 8E 首个正式 Web 纵向切片 | Stage 8 同期深化证据、工具、评测、历史、SSE 和状态展示 | 桌面/移动截图、键盘操作、reduced-motion、loading/empty/error/degraded 状态和数据边界展示 | 已规划，entry design pending public CI |
