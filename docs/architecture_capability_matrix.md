...
| Q10 | 前端可解释性与可访问性 | 8E Batch B/C 已公共闭环 profile/routing 与 evidence/SSE/四态 DTO；Batch D design `88a5ab6/32631766013` 和 fixture React implementation `f7ebedd/32636771507` 均公共闭环，覆盖七场景、forbidden-field、Evidence Drawer、Training 与持久截图；RQ-094 固定 `Rift Awakening → Esports Intelligence`，Void 仅受限 Hero 实验 | Stage 8 8E 首个正式 Web 纵向切片 | RQ-095 先实现 latest locator、Recent Summary、typed Evidence、exact decoder/generation/EventSource；之后继续电影感入口、真实 Rift Timeline、完整 Training、Auth/部署，并在 8F 前完成 fusion→Training→UI golden slice | desktop/tablet/mobile、键盘/Escape/焦点返回、reduced-motion、axe critical/serious 0、no-remote-I/O、identity race/SSE cleanup、restricted Markdown、状态/数据边界和人工截图 QA | Batch D 同 SHA unit 35/e2e 12/typecheck/build、公共 pytest 1752 与三 job 全绿；live integration design `4057c93/32639561338` 已公共关闭，implementation prepared/waiting authorization |
