...
| A15 | 标准 MCP 与动态 Meta | 内部 Tool Runtime 不冒充 MCP；7-1/7-2/7-3/7-4 已由 `37f16bc/32439753589`、`f121666/32441793585`、`64311a1/32455219404`、`431c584/32480827952` 公共闭环；RQ-079/ADR-0050 已本地实现锁版官方 SDK Client→RiftCoach stdio Server 与 clean-SHA 双向 runner | 阶段 7 | 7-5 尚待实现 exact-SHA CI 与一次 RiftCoach→OP.GG 真实退出证据；Riot 官方版本/静态/patch 事实与 OP.GG 聚合 Meta 分层；其他 OP.GG 工具逐项 Adapter | initialize、tools/list、tools/call、断线、版本与 owner 边界测试；真实外部 Server/Client 互操作 | 进行中（7-5 本地实现，待公共/真实退出门） |
