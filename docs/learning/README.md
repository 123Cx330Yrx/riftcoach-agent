...
| 7-4：RiftCoach MCP Server | 本地实现/全部门禁完成，待公共闭环 | [ADR-0049](../adr/0049-adopt-restricted-riftcoach-mcp-server-facade.md) / [设计](../plans/2026-08-21-riftcoach-mcp-server-design.md) / [walkthrough](7-4-riftcoach-mcp-server-walkthrough.md) | strict Session、owner-scoped Facade、verified recent DTO、single-review digest、knowledge attribution 与 evaluation status 已完成 TDD/本地门；不含公网 transport/7-5 互操作 |
...
- 6B-9 与 Session/Memory V1 已完成公共 PostgreSQL/package 闭环；这仍不表示正式 Auth/RSO、备份副本擦除、
  ...
  单向产品链和 partial provenance；7-4 Server 已完成本地 TDD/全部门禁、尚待 exact-SHA 公共闭环，
  7-5 双向退出门仍未进入。
