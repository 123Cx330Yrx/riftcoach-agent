...
| 8E：Productization preflight | 进行中/coverage planned | [preflight 计划](../plans/2026-08-23-8e-productization-preflight.md) / [ADR-0056](../adr/0056-adopt-bounded-external-validation-and-player-profile-selection.md) | RQ-086 已授权；OP.GG 一次真实 body-free gate 已通过，Riot gate 等待准确测试 Riot ID；玩家档案选择、legacy 地区审计和前端小批尚未完成 |
