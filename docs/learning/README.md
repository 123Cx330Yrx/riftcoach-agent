...
| 8E：Productization | 进行中/coverage planned | [preflight 计划](../plans/2026-08-23-8e-productization-preflight.md) / [玩家档案与显式路由 walkthrough](8e-player-profile-selection-explicit-routing-walkthrough.md) / [ADR-0059](../adr/0059-adopt-owner-scoped-player-profiles-and-explicit-riot-routing.md) / [专用设计](../plans/2026-08-23-player-profile-selection-explicit-routing-design.md) | OP.GG live/public 链与 Batch B `e844bdd/32622696087` 均已公共闭环；owner-scoped 玩家档案、opaque selection、逐请求四地区路由与本机 PostgreSQL/Docker 环境已有证据。整个 coverage 仍 planned；下一批为 EvidenceBundle store/refresh/expiry、SSE/四态 DTO，前端尚未开始 |
