...
| 6B-6：Preferences / Profile / Review Memory | 未开始/待授权 | [Session/Memory 总设计](../plans/2026-08-19-stage6-session-memory-design.md) / [总实施计划](../plans/2026-08-19-stage6-session-memory-implementation.md) | 下一检查点只 prepared；将来才建立三类 typed target 与真实 materializer |
