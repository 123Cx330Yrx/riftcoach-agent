...
| 8E：Productization | 进行中/coverage planned | [preflight](../plans/2026-08-23-8e-productization-preflight.md) / [Batch B](8e-player-profile-selection-explicit-routing-walkthrough.md) / [Batch C](8e-evidence-product-api-walkthrough.md) / [Batch D](8e-batch-d-rift-command-center-walkthrough.md) / [五模块资源矩阵](../plans/2026-08-23-8e-five-module-visual-resource-research.md) / [ADR-0061](../adr/0061-adopt-fixture-backed-rift-command-center-and-multi-source-visual-gate.md) / [ADR-0062](../adr/0062-adopt-latest-profile-review-locator-and-client-composed-live-workbench.md) / [Live 接线设计](../plans/2026-08-23-8e-live-workbench-integration-design.md) | OP.GG live/public 链、Batch B `e844bdd/32622696087`、Batch C `7975dc3/32629160732` 与 Batch D `f7ebedd/32636771507` 均公共闭环；RQ-094 恢复 A→B 视觉组合、小复盘、OP.GG breadth 与完整 fusion golden slice。RQ-095 live integration design `4057c93/32639561338` 已公共闭环，implementation 仅 prepared/waiting authorization；整个 8E coverage 仍 planned，真实接线/Auth/部署、电影感入口、完整 Timeline/Training 与两个后续验收未实现 |
