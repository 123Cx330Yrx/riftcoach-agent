...
| 8C：Reliable Runtime Core | 本地实现完成/待公共闭环 | [walkthrough](8c-reliable-runtime-core-walkthrough.md) / [ADR-0054](../adr/0054-adopt-postgresql-leased-fenced-task-control-plane.md) / [专用设计](../plans/2026-08-22-8c-reliable-runtime-core-design.md) | 0010、durable event/replay、lease/fencing、持久 cancel、checkpoint/receipt recovery、Worker/API/package 纵向已本地完成；最新完整回归 `1670 passed, 133 skipped, 1 warning, 127 subtests passed`，真库/Linux 与 coverage complete 仍等待 implementation exact-SHA 三 job |
