...
> 当前学习指针（2026-09-06，RQ-243）：[候选生成/修订合同对齐](../plans/2026-09-06-candidate-generation-revision-contract-alignment.md)。本地 144 项测试通过，待公共 CI；学习重点是提示、验证、版本身份三者一致，以及模拟控制流不能代替真实质量。旧经济场景仍失败，8E coverage 仍 planned，未准入生产；历史诊断见 [RQ-242](../plans/2026-09-06-guided-domain-candidate-assets.md)。
