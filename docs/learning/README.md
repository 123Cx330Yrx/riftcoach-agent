...
| 8E：Productization preflight | 进行中/coverage planned | [preflight 计划](../plans/2026-08-23-8e-productization-preflight.md) / [ADR-0056](../adr/0056-adopt-bounded-external-validation-and-player-profile-selection.md) / [ADR-0057](../adr/0057-record-body-free-opgg-schema-drift-diagnostics.md) / [ADR-0058](../adr/0058-admit-json-null-for-opgg-nullable-rank-history.md) | RQ-087 live diagnostic 定位 `Mid.rank_prev_patch` AST `Name`；窄修复由 `83fde7d/32615340228` 公共闭环，RQ-088 下修复后 replay 又创建 body-free bundle。Akali top-10 Meta join 仍诚实 degraded；玩家档案选择、legacy 地区审计和前端小批尚未完成 |
