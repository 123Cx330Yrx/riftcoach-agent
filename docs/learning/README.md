...
> 当前学习指针（2026-09-06，RQ-242）：[开发观察、修订诊断与产品接入差异](../plans/2026-09-06-guided-domain-candidate-assets.md)。经济观察取得 3 来源但修订拒绝；诊断修复 117 项测试及 `a64331b` / CI `34022245397` 三任务通过。下一项是生成/修订合同对齐。学习重点是中间评分与最终评分分离、验证规则与错误可观测性分离；8E coverage 仍 planned，未准入生产。
