...
| 7-3：OP.GG Meta Adapter | 准备/等待授权 | [入口设计](stage-7-standard-mcp-dynamic-meta-entry-design.md) / [ADR-0047](../adr/0047-adopt-standard-mcp-boundary-and-opgg-meta-adapter.md) / [实施计划](../plans/2026-08-21-stage7-standard-mcp-dynamic-meta-implementation.md) | 仅保留 OP.GG endpoint/protocol/license/freshness/互操作准入清单；尚未审计、实现 MetaEvidence 或读取 Key |
