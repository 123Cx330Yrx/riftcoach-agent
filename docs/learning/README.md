...
> 当前学习指针（2026-09-06，RQ-247）：[产品验收计划的 RQ-247 追加节](../plans/2026-09-06-coach-product-acceptance-preparation.md)。先区分已知缺陷、真实失败未知项与资源限制：3个失败用例证明评测一致性和引用修订缺口，新显式版本修复并补安全诊断；high/8192与时间放宽不替代修复或质量证明。修复阶段真实调用0，旧3+13次真实记录保留，待本版本公共验证。八维说明复用该计划，所有者理解未新增确认，8E coverage仍planned，生产稳定性/默认启用未完成。
