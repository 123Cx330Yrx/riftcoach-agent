...
| 8E：Productization | 进行中/coverage planned | [preflight 计划](../plans/2026-08-23-8e-productization-preflight.md) / [玩家档案与显式路由 walkthrough](8e-player-profile-selection-explicit-routing-walkthrough.md) / [ADR-0059](../adr/0059-adopt-owner-scoped-player-profiles-and-explicit-riot-routing.md) / [专用设计](../plans/2026-08-23-player-profile-selection-explicit-routing-design.md) | OP.GG nullable-null live/public 闭环保持；当前 Batch B 已本地实现 owner-scoped 玩家档案、opaque selection 与逐请求四地区 Riot 路由，并补齐本机 PostgreSQL 17/Docker/Linux Compose 验证条件。coverage 仍 planned，须待独立 exact-SHA 三 job 后关闭本批；前端尚未开始 |
