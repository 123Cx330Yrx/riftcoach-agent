...
| 8E：Productization | 进行中/coverage planned | [preflight](../plans/2026-08-23-8e-productization-preflight.md) / [Batch B](8e-player-profile-selection-explicit-routing-walkthrough.md) / [Batch C](8e-evidence-product-api-walkthrough.md) / [Batch D](8e-batch-d-rift-command-center-walkthrough.md) / [Live 接线](8e-live-workbench-integration-walkthrough.md) / [五模块资源矩阵](../plans/2026-08-23-8e-five-module-visual-resource-research.md) / [ADR-0061](../adr/0061-adopt-fixture-backed-rift-command-center-and-multi-source-visual-gate.md) / [ADR-0062](../adr/0062-adopt-latest-profile-review-locator-and-client-composed-live-workbench.md) | OP.GG live/public 链、Batch B `e844bdd/32622696087`、Batch C `7975dc3/32629160732` 与 Batch D `f7ebedd/32636771507` 均公共闭环；RQ-096 live integration 已完成本地 locator/Summary/typed Evidence、exact decoder/controller/EventSource 和 default-live UI，完整 pytest 1939、真库 200、frontend unit 66/e2e 17 与 Linux package 全绿，当前只待独立 implementation/evidence SHA 的公共三 job。整个 8E coverage 仍 planned；Auth/部署、电影感入口、完整 Timeline/Training、OP.GG breadth 与 fusion golden slice 未完成 |
