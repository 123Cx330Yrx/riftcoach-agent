...
> 当前学习指针（2026-09-05，RQ-235）：先阅读 [V3 实现与真实检索归因 walkthrough](8e-glm53-hardened-domain-v3-bounded-revision-implementation-walkthrough.md)、
...
> 8E coverage 仍 planned，候选未注册。V3 真实首案因检索零片段安全停止，未进入评分/修订；下一步离线加固检索合同；
> 黄金切片、生产准入和 8F 均未进入。
