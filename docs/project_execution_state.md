...
- RQ-223 最新状态覆盖：已在隔离工作树完成候选评测作用域、共享 `request_policy` 接缝和
  ...
  Workbench、Auth、路由和 `production_media=0` 不变。等待同一实现 SHA 的公共 exact-SHA CI。
