...
lease/fencing、cancel、checkpoint、recovery 与迟到隔离；RQ-084 已授权 `8D`，当前以 ADR-0055 和
pure TDD 实施 Riot 官方事实、Data Dragon 静态、官方 patch/update 与 OP.GG partial Meta 的 typed
fusion；`8E` 实施 Web/SSE/Auth/HTTPS/
