...
RQ-243 已本地完成候选报告合同对齐（144 项测试，待公共 CI）；新开发身份不升级旧正式证据，实际模型调用为 0。完整预算、产品迁移与正式领域仍后置；8-Core/8-Advanced 与 8F 退出规则不变，详见 [计划](plans/2026-09-06-candidate-generation-revision-contract-alignment.md)。
