...
三类匿名输入已通过新合同完整九请求本地路径，104 项测试通过；预留 202346/202310/202250，未扩大 205000 墙。当前待本实现公共 CI，之后新产品执行组合离线接线；取代 RQ-243 的待预算动作，不改变历史结果。固定样例估算不等于任意产品输入或真实模型质量，8E/8F 和质量门不变。详见 [计划](plans/2026-09-06-report-contract-budget-and-runtime-migration.md)。
