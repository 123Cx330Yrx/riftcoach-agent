...
采用明确指引及同等验证，不删除旧标题/篇幅/引用要求，不自动改写报告或追加重试；新合同仅准入具名新开发计划和匿名 demo，旧路径不变。144 项测试通过，待公共 CI；后续完整预算与产品迁移版本对齐。此次并非生产注册或旧经济失败重测，详见 [计划](plans/2026-09-06-candidate-generation-revision-contract-alignment.md)。
