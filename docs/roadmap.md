...
| 6 | API、Session 与 Memory | 如何从脚本变成真正的长期个性化 Coach | EchoMind 迁移重构 | 进行中；6A-1/6A-2 已由 `854e52d/32043214500`、`012b066/32046532695` 真库公共完成，6A-3 claim/Worker 已本地实现，待公共 PostgreSQL CI |
