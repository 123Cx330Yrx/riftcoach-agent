...
RQ-108 runtime Task 1 已本地完成 strict manifest、cover/focal/hitBox geometry 与 preflight-first media policy：
focused 71、frontend unit 207、typecheck/build 全绿，bundle unchanged；当前只待独立 implementation/evidence
commit 与 exact-SHA 三 job，公共成功前不进入播放组件 Task 2。
